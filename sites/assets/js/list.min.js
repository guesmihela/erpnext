(function () {
	...
	frappe.views.BaseList = class BaseList {
		...
		get_filter_value(fieldname) {
			return this.get_filters_for_args().filter(function (f) { return f[1] == fieldname; })[0] &&
				this.get_filters_for_args().filter(function (f) { return f[1] == fieldname; })[0][3];
		}
	...
	frappe.views.ListView = class ListView extends frappe.views.BaseList {
		...
		get_no_result_message() {
			...
			var no_result_message = filters.length ? __('No {0} found', [__(this.doctype)]) : __('You haven\'t created a {0} yet', [__(this.doctype)]);
			var new_button_label = filters.length ? __('Create a new {0}', [__(this.doctype)]) : __('Create your first {0}', [__(this.doctype)]);
			var empty_state_image = this.settings.empty_state_image || '/assets/frappe/images/ui-states/empty.png';
	...
	frappe.views.DashboardView = class DashboardView extends frappe.views.ListView {
		...
		setup_dashboard_page() {
			var dashboard_name = __('{0} Dashboard', [this.doctype]);
		...
		setup_events() {
			...
			$(document.body).on('toggleFullWidth', function () { return this$1.render_dashboard(); });
			$(document.body).on('toggleListSidebar', function () { return this$1.render_dashboard(); });
		}
		...
		render_empty_state() {
			...
			var empty_state_image = '/assets/frappe/images/ui-states/empty.png';
